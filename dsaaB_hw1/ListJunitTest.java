...
public class ListJunitTest {
    ...
    public void test1() {
        ...
        assertEquals("[7, 8, 9, 11]",list1.toString());
        list1.deleteNode(0);list1.deleteNode(2);
    ...
    public void test2() {
        ...
        list1.sort();System.out.println("after sorting:"+list1);
        //list1.reverse();System.out.println("reverse:"+list1);
        list1.addNodeSorted(node5);	System.out.println("addNodeSorted:"+list1);
        ListNode node6 = new ListNode(9);
        list1.deleteNode(node6);System.out.println("delete:"+list1);
        list1.deleteNode(-1);System.out.println("delete:"+list1);
        list1.deleteDuplicates();System.out.println("deleteDuplicates:"+list1);
        list1.deleteSortedDuplicates();System.out.println("deleteDuplicates:"+list1);
        ListNode node11 = new ListNode(1);
        List list2 = new List(node11);
        ListNode node12 = new ListNode(9);
        list2.addNode(node12);
